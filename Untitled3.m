...
[predicted_labels_SVM,accuracy_svm] = SVM_classifier(abs(data_train),label_train,abs(data_test),label_test);
[predicted_labels_KNN,accuracy_knn] = KNN_classifier(3,data_train,label_train,data_test,label_test);
